...
license: "MIT"
metadata: {"author":"https://github.com/Jeffallan","version":"1.1.0","domain":"api-architecture","triggers":"WebSocket, Socket.IO, real-time communication, bidirectional messaging, pub/sub, server push, live updates, chat systems, presence tracking","role":"specialist","scope":"implementation","output-format":"code","related-skills":"fastapi-expert, nestjs-expert, devops-engineer, monitoring-expert, security-reviewer"}
---
# WebSocket Engineer
