...
license: "MIT"
metadata: {"author":"https://github.com/Jeffallan","version":"1.1.0","domain":"data-ml","triggers":"pandas, DataFrame, data manipulation, data cleaning, aggregation, groupby, merge, join, time series, data wrangling, pivot table, data transformation","role":"expert","scope":"implementation","output-format":"code","related-skills":"python-pro"}
---
# Pandas Pro
