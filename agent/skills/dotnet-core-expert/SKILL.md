...
license: "MIT"
metadata: {"author":"https://github.com/Jeffallan","version":"1.1.0","domain":"backend","triggers":".NET Core, .NET 8, ASP.NET Core, C# 12, minimal API, Entity Framework Core, microservices .NET, CQRS, MediatR","role":"specialist","scope":"implementation","output-format":"code","related-skills":"fullstack-guardian, microservices-architect, cloud-architect, test-master"}
---
# .NET Core Expert
