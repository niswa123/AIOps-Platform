...
license: "MIT"
metadata: {"author":"https://github.com/Jeffallan","version":"1.1.0","domain":"language","triggers":"C#, .NET, ASP.NET Core, Blazor, Entity Framework, EF Core, Minimal API, MAUI, SignalR","role":"specialist","scope":"implementation","output-format":"code","related-skills":"api-designer, database-optimizer, devops-engineer"}
---
# C# Developer
