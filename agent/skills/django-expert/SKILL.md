...
license: "MIT"
metadata: {"author":"https://github.com/Jeffallan","version":"1.1.0","domain":"backend","triggers":"Django, DRF, Django REST Framework, Django ORM, Django model, serializer, viewset, Python web","role":"specialist","scope":"implementation","output-format":"code","related-skills":"fullstack-guardian, fastapi-expert, test-master"}
---
# Django Expert
